<?php session_start(); 
unset($_SESSION['m_pseudo']);
unset($_SESSION['m_mot_de_passe']);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<form class="form-horizontal" action="cree_compte_verify.php" method="post">
...
<br>
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-2">
      <button type="submit" class="btn btn-primary btn-lg center-block">Créez un compte !</button>
    </div>
  </div>
</form>
